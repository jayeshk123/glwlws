		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-sm-3">
					<div class="img_zoom">
						<a href="#"><img style="max-height:240px;min-height:240px;" src="http://greenleafwildlife.com/wp-content/uploads/2015/06/tadoba7-580x460.jpg" alt="" class="img-responsive"></a>
					</div>
					<h3>Jungle Safari <span class="price_home">5 Days<em></em></span></h3>
					<p>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.
					</p>
					<p>
				...
				<div class="col-md-3 col-sm-3">
					<div class="img_zoom">
						<a href="#"><img style="max-height:240px;min-height:240px;" src="http://greenleafwildlife.com/wp-content/uploads/2015/07/IMG_1156-580x460.jpg" alt="" class="img-responsive"></a>
					</div>
					<h3>Bird Watching <span class="price_home">5 Days<em></em></span></h3>
					<p>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.
					</p>
					<p>
				...
				<div class="col-md-3 col-sm-3">
					<div class="img_zoom">
						<a href="#"><img style="max-height:240px;min-height:240px;" src="http://greenleafwildlife.com/wp-content/uploads/2015/06/IMG-20150607-WA0016.jpg" alt="" class="img-responsive"></a>
					</div>
					<h3>Photography <span class="price_home">5 Days<em></em></span></h3>
					<p>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.
					</p>
					<p>
				...
				<div class="col-md-3 col-sm-3">
					...
					<h3>Jungle Trail <span class="price_home">5 Days<em></em></span></h3>
					<p>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.
					</p>
					<p>
