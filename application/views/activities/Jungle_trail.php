...
<head>
	...
	<title>Green Leaf Wild Life - Jungle Trail</title>
		...
		<div class="row">
			<div class="col-lg-9 col-md-8">
				...
				<ul class="nav nav-tabs nav-justified">
					<li class="active"><a href="#family-tour" data-toggle="tab">Family Tours</a></li>
					<li><a href="#corporate-tour" data-toggle="tab">Corporate Tours</a></li>
					<li><a href="#private-groups" data-toggle="tab">Private Groups</a></li>
				</ul>

				<div class="tab-content">
					<div class="tab-pane active fade in" id="family-tour">
						<div class="fadeIn">
							<div class="row">
					...
					<div class="tab-pane fade in" id="corporate-tour">
						<div class="fadeIn">
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-4">
									<div class="img_list">
					...
					<div class="tab-pane fade in" id="private-groups">
						<div class="fadeIn">
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-4">
									<div class="img_list">
